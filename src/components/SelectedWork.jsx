        ...
        {activeMissions.map((project, idx) => (
          <div key={project.id} className="inline-flex items-center gap-6 sm:gap-10">
            <a
              ...
              className="text-xl sm:text-2xl font-medium text-ivory hover:text-oxide focus:outline-none focus-visible:text-oxide transition-colors duration-200 tracking-tight drop-shadow-sm"
            >
