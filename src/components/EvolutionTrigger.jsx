  ...
  return (
    <>
      <button
        ...
        className={`fixed top-4 right-4 sm:top-6 sm:right-6 z-50 min-h-[44px] px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-md border transition-all duration-200 group flex items-center gap-2.5 cursor-pointer select-none shadow-md backdrop-blur-md outline-none focus-visible:ring-1 focus-visible:ring-copper ${
          isOpen
