...
export default function MinimalHero() {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-center text-center">
      ...
      <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-border bg-graphite/90 text-micro text-copper font-mono tracking-widest uppercase mb-6 select-none shadow-md">
        <span className="w-1.5 h-1.5 rounded-full bg-copper animate-ping" />
        <span>raghu_007</span>
      </div>

      {/* Main Name */}
      <h1 className="text-4xl sm:text-6xl text-ivory font-semibold tracking-tight mb-4 text-center drop-shadow-md">
        Raghavendra Singh
      </h1>
